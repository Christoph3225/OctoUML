...
public class SequenceDiagramController extends AbstractDiagramController {
  ...
  void initDrawPaneActions() {
    ...
    drawPane.setOnMouseDragged(event -> {
      ...
      else if (tool == ToolEnum.MOVE_SCENE && mode == Mode.MOVING) { // Continue
                                                                     // panning
                                                                     // of
                                                                     // graph.
   ...
   * @return
   */
  public AbstractEdgeView createEdgeView(MessageEdge edge, AbstractNodeView startNodeView, AbstractNodeView endNodeView) {
