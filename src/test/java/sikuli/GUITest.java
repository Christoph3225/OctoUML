...
public class GUITest {
    ...
    public void testGUI() throws FindFailed {
        ...
        screen.click("src/test/resources/sikuli/images/undoButton.PNG"); //Undo second transform
        screen.click("src/test/resources/sikuli/images/undoButton.PNG"); //Undo draw first line
        screen.click("src/test/resources/sikuli/images/undoButton.PNG"); //Undo draw second rectangle
        screen.click("src/test/resources/sikuli/images/undoButton.PNG"); //Undo first transform
        screen.click("src/test/resources/sikuli/images/undoButton.PNG"); //Undo draw first rectangle

        assertEquals(screen.exists("tests/sikuli/images/recognizedDiagram.PNG"), null);

        screen.click("src/test/resources/sikuli/images/redoButton.PNG"); //redo draw first rectangle
        screen.click("src/test/resources/sikuli/images/redoButton.PNG"); //redo first transform
        screen.click("src/test/resources/sikuli/images/redoButton.PNG"); //redo draw second rectangle
        screen.click("src/test/resources/sikuli/images/redoButton.PNG"); //redo draw first line
        screen.click("src/test/resources/sikuli/images/redoButton.PNG"); //redo second transform
